...
/** @type {string} */
const CACHE_VERSION = '1766619049|42636518567';
/** @type {string} */
const CACHE_PREFIX = 'questionnaire-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'questionnaire.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["questionnaire.html","questionnaire.js","questionnaire.offline.html","questionnaire.icon.png","questionnaire.apple-touch-icon.png","questionnaire.audio.worklet.js","questionnaire.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["questionnaire.wasm","questionnaire.pck"];
